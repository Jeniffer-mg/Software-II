        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a href="participacionGI.html" target="_blank" class="nav-link">Investigadores</a>
                    </li>
                    <li class="nav-item">
                        <a href="produccionUbI.html" target="_blank" class="nav-link">Producción</a>
                    </li>
                    <li class="nav-item">
                        <a href="clasificacionUbI.html" target="_blank" class="nav-link active">Clasificación</a>
                    </li>
                    <li class="nav-item">
