...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a href="UbGI.html" class="nav-link">Inicio</a>
                    </li>
                    <li class="nav-item">
                        <a href="datosGeneralesUbGI.html" target="_blank" class="nav-link">Datos Generales</a>
                    </li>
                    <li class="nav-item">
                        <a href="investigadoresUbGI.html" target="_blank" class="nav-link">Investigadores</a>
                    </li>
                    <li class="nav-item">
                        <a href="produccionUbGI.html" target="_blank" class="nav-link active">Producción</a>
                    </li>
                    <li class="nav-item">
                        <a href="clasificacionUbGI.html" target="_blank" class="nav-link">Clasificación</a>
                    </li>
                    <li class="nav-item">
                        <a href="inicioSesionUbGI.html" target="_blank" class="nav-link">Salir</a>
                    </li>
    ...
    <div>
        <p class="center-content simular"><input type="submit" class="btn btn-danger" value="Vincular Producto"></p>
    </div>
