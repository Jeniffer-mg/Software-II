        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a href="datosGeneralesUbI.html" target="_blank" class="nav-link">Datos Generales</a>
                    </li>
                    <li class="nav-item">
                        <a href="participacionGI.html" target="_blank" class="nav-link active">Investigadores</a>
                    </li>
                    <li class="nav-item">
                        <a href="produccionUbI.html" target="_blank" class="nav-link">Producción</a>
                    </li>
                    <li class="nav-item">
                        <a href="clasificacionUbI.html" target="_blank" class="nav-link">Clasificación</a>
                    </li>
                    <li class="nav-item">
                        <a href="inicioSesionUbI.html" target="_blank" class="nav-link">Salir</a>
                    </li>
